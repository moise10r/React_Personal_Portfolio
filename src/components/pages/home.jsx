...
class Home extends Component {
	...
	render() {
		...
		return (
			...
			<div className={isOpen ? ("card-popup-window"):("card-popup-window open-pop-up")}>
					...
					<div className="left-container">
							...
							<div className="about-links">
								<ul className="languages" id="lang">
									...
									<div className="links">
										<a href="#2" className="btn"><span>see live</span><span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="#cf000f">
											...
											<a href="#2" className="btn"><span>source code</span> <span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 18 20" fill="#cf000f">
